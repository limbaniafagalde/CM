...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <?php
            $columna = "id";
            $valor = substr($_GET["url"], 6); //de la barra de nav quito todo hasta obtener el id del doc
            ...
            echo '<h1>Consultorio: '.$consultorios["nombre"].'</h1>';
        ?>
