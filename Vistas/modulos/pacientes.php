        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <button class="btn btn-primary btn-md" data-toggle="modal" data-target="#CrearPaciente">Crear Paciente</button>
                </div>
                                    ...
                                    <td>'.$value["clave"].'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <button class="btn btn-success EditarPaciente" Pid="'.$value["id"].'" data-toggle="modal" data-target="#EditarPaciente">
                                                    <i class="fa fa-pencil"></i>
                                                    Editar
                                                </button>
                                                
                                                <button class="btn btn-danger EliminarPaciente" Pid="'.$value["id"].'" imgP="'.$value["foto"].'">
              ...
              <div class="modal-body">
                  <div class="box-body">
                      <div class="form-group">
                          ...
                          <input type="hidden" name ="rolP" value="Paciente"> <!-- inserto el rol de manera oculta-->
                      </div>
                      <div class="form-group">
                          <h2>Nombre:</h2>
                      ...
                      <div class="form-group">
                          <h2>Usuario:</h2>
                          <input type="text" class="form-control input-md" id = "usuario" name="usuario" required>
                      </div>
                      <div class="form-group">
                          <h2>Contraseña:</h2>
           ...
           <form method="post" role="form">
              <div class="modal-body">
                  <div class="box-body">
                      ...
                      <div class="form-group">
                          <h2>Documento:</h2>
                          <input type="text" class="form-control input-md" id="documentoE" name="documentoE" required>
                      </div>
